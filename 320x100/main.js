...
function animate() {
  ...
  tl.addLabel('frame3', 5)
    ...
    .to(['#horse'], 1, { left: '261px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.6')
    .to(['#logo_text'], 1, { left: '246px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.7')
    .to(['#copy3'], 1, { left: '16px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.8')
    // .to(['#horse'], 1, { autoAlpha: 0, ease: "power1.inOut", }, 'frame3+=1.5')
    // .to(['#horse_gif'], 1, { autoAlpha: 1, ease: "power1.inOut", yoyo: true }, '<')
    .to(['#cta'], 0.5, { autoAlpha: 1, ease: "power1.inOut", }, 'frame3+=2.3')
    .to(['#copy3'], 1, { autoAlpha: 0, ease: "power1.inOut", }, 'frame3+=3')

    
    .to(['#copy4'], { autoAlpha: 1, ease: "power1.inOut", }, 'frame3+=3.8')
