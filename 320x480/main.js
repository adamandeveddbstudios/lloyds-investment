...
function animate() {
  ...
  .to(['#lineone'], 1, {top:'337px', autoAlpha: 1, ease: 'bounce.out', yoyo: true }, 'frame1')
  .to(['#linetwo'], 1, {top:'389px', autoAlpha: 1, ease: 'bounce.out', yoyo: true }, 'frame1+=0.5')

  tl.addLabel('frame2', 2)
  .to(['#lineone, #linetwo'], 0.5, {autoAlpha: 0, ease: "power1.inOut", yoyo: true }, 'frame2')
  .to(['#copy2'], 1, {top:'216px', autoAlpha: 1, ease: 'bounce.out', yoyo: true }, 'frame2+=.5')
