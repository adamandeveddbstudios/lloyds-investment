...
function animate() {
  ...
  tl.addLabel('frame3', 5)
    ...
    .to(['#horse'], 1, { left: '276px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.6')
    .to(['#logo_text'], 1, { left: '265px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.7')
    .to(['#copy3'], 1, { left: '10px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.8')
